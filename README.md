...
- [Network Analyzer](#network-analyzer)
  - [Функциональные возможности](#функциональные-возможности)
    - [Приём данных (ZMQ-сервер)](#приём-данных-zmq-сервер)
    - [База данных](#база-данных)
    - [Графический интерфейс](#графический-интерфейс)
    - [Карта и тепловая карта](#карта-и-тепловая-карта)
    - [Android-клиент](#android-клиент)
    - [Вспомогательные материалы](#вспомогательные-материалы)
  - [Структура проекта](#структура-проекта)
    - [Архитектура при запуске](#архитектура-при-запуске)
  - [Требования](#требования)
    - [Обязательно: Docker](#обязательно-docker)
    - [Окружение хоста](#окружение-хоста)
    - [Дополнительно](#дополнительно)
  - [Запуск через script.sh](#запуск-через-scriptsh)
    - [1. Клонирование](#1-клонирование)
    - [2. Запуск скрипта](#2-запуск-скрипта)
    - [3. Что поднимается](#3-что-поднимается)
    - [4. Остановка](#4-остановка)
  - [Подготовка исторических данных (опционально)](#подготовка-исторических-данных-опционально)
